...
import com.dougfsilva.controlesaidaescolar.dto.SaidaAlunoForm;
...
public class SolicitaSaidaService {
	...
	public SaidaAluno solicitar(SaidaAlunoForm form) {
	...
	private void validarNenhumaOutraSaidaSolicitadaNoDia(Aluno aluno) {
		...
		if (saidaAlunoRepository.existsByAlunoIdAndSolicitacaoDataHoraSolicitacaoBetween(aluno.getId(), inicioDia,
				fimDia)) {
